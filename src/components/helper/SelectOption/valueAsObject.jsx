...
export default function SelectOptionAsObjectValue(
  {options, onChange,label, value,
    ...
    optionClass="absolute bg-white text-left text-graySubHd overflow-auto py-2.5 space-y-2 min-w-fit"
}) {
    ...
    <div style={{position:"relative", width:"100%"}} onClick={() => toggle(!show)} >
        <div className={"cursor-pointer flex justify-between border py-2.5 px-4 gap-x-2 items-center "+containerClass}  
            style={{
            background: '#FFFFFF',
            ...style
