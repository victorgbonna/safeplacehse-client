...
export default function ProjectHelper({}){
    ...
    return (
    <section className='bg-[url("/images/project-new52.png")] flex flex-col items-center w-screen h-fit bg-cover bg-top px-[100px]'>
        <div className='w-fit flex flex-col justify-center items-center mb-10'>
            <h4 className='text-3xl mb-2 px-3 font-semibold'>PROJECTS</h4>
            <span className='w-[30%] border-green h-[1px] border'></span>
        </div>
        <div className="space-y-10">
            {projects.map(({img, title, desc},ind)=>
                <div key={ind} className={`bg-white border border-green relative shadow-xl  rounded-md p-7 flex gap-x-10 items-center tablet:flex-col`}>
                ...
                <div className='w-[500px] tablet:w-full'>
                    ...
                    <button className='mt-6 flex justify-center items-center gap-x-2 bg-green text-white font-medium px-8 py-2 rounded-full hover:opacity-90'>
                    <p>View Project</p>
